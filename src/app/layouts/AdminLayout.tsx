...
const navigation = {
  ...
  CUSTOMER_SUPPORT: [
    ...
    ["/support/conversations", "Hội thoại & chuyển tiếp", Radio],
  ...
  FINANCE: [
    ...
    ["/finance/payments", "Xác minh thanh toán", CreditCard],
    ["/finance/investigations", "Điều tra tài chính", FileClock],
