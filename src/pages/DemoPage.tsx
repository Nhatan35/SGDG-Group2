...
const groups: DemoGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Phiên thất bại & hoàn cọc", description: "Tự tạo yêu cầu hoàn cọc khi Top 3 không hình thành người thắng.", to: "/me/auctions/patek-nautilus/result?scenario=top3-exhausted", access: "customer" },
      ...
      { label: "Quá hạn & thu cọc", description: "Người thắng không thanh toán đúng hạn.", to: "/me/auctions/patek-nautilus/payment?scenario=defaulted", access: "customer" },
      ...
      { label: "Lịch sử tiền cọc", description: "Theo dõi giữ, hoàn, khấu trừ và thu cọc.", to: "/account/deposits", access: "customer" },
